								...
								<div class="row">
									<div class="col-12 col-md-6 col-lg-4 d-flex">
										<div class="card flex-fill">
											<img alt="Card Image" src="../assets_admin/img/profiles/avatar-02.jpg" class="card-img-top">
											<div class="card-header">
							...
							<section class="comp-section">
	                            ...
	                            <div class="card">
	                            	...
	                            	<div class="card-body">
	                            		...
	                            		<div class="modal-1 static-modal" tabindex_admin="-1" role="dialog">
	                            ...
	                            <div class="card">
					                ...
					                <div class="modal fade" id="exampleModal" tabindex_admin="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				                    ...
				                    <div class="modal fade" id="exampleModalLong" tabindex_admin="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
				                      	<div class="modal-dialog" role="document">
				                        	<div class="modal-content">
					                          	<div class="modal-header">
				                    ...
				                    <div class="modal fade" id="exampleModalCenter" tabindex_admin="-1" role="dialog" aria-labelledby="exampleModalCenter" aria-hidden="true">
				                    ...
				                    <div class="modal fade" id="tooltipmodal" tabindex_admin="-1" role="dialog" aria-labelledby="tooltipmodal" aria-hidden="true">
				                      	<div class="modal-dialog modal-dialog-centered" role="document">
					                        <div class="modal-content">
					                          <div class="modal-header">
					                            	<h5 class="modal-title">Modal title</h5>
				                    ...
				                    <div class="modal fade" id="grid-modal" tabindex_admin="-1" role="dialog" aria-labelledby="grid-modal" aria-hidden="true">
				                      	<div class="modal-dialog modal-dialog-centered" role="document">
					                        <div class="modal-content">
					                          	<div class="modal-header">
					                            	<h5 class="modal-title">Modal title</h5>
	                            ...
	                            <div class="card">
	                            	...
	                            	<div class="card-body btn-showcase">
				                    	...
				                    	<div class="modal fade" id="exampleModalfat" tabindex_admin="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				                      		<div class="modal-dialog" role="document">
				                        		<div class="modal-content">
				                          			<div class="modal-header">
				                    ...
				                    <div class="modal fade" id="exampleModalmdo" tabindex_admin="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				                      <div class="modal-dialog" role="document">
					                        <div class="modal-content">
					                          	<div class="modal-header">
				                    ...
				                    <div class="modal fade" id="exampleModalgetbootstrap" tabindex_admin="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				                      	<div class="modal-dialog" role="document">
					                        <div class="modal-content">
					                          	<div class="modal-header">
					                            	<h5 class="modal-title">New message</h5>
	                            ...
	                            <div class="card">
									...
									<div class="modal fade bd-example-modal-xl" tabindex_admin="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				                    ...
				                    <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg" data-original-title="" title="">Large modal</button>
				                    	<div class="modal fade bd-example-modal-lg" tabindex_admin="-1" role="dialog" aria-labelledby="myLargeModalLabel1" aria-hidden="true">
				                    ...
				                    <div class="modal fade bd-example-modal-sm" tabindex_admin="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
