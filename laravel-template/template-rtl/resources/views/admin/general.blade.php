						...
						<div class="col-md-4">
							<div class="card">
								<div class="card-header all-center">
									<a href="general" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="../assets_admin/img/profiles/avatar-01.jpg" alt="User Image">
								...
								<div class="card-body p-0">
									...
									<div class="profile-list">
										<a href="group-history"><button type="button" class="btn btn-block btn-outline-light">View History</button></a>
									</div>
								</div>
							</div>
						</div>
