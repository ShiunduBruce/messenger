                ...
                <div id="chats" class="left-sidebar-wrap sidebar active">
                    <div class="header">
                        ...
                        <ul class="nav nav-tabs chat-tabs mt-4">
                            ...
                            <li class="nav-item ms-1">
                                <a class="nav-link  active" href="call-log">Call</a>
                            </li>
                        </ul>
                        <button type="button" class="float-end btn btn-circle btn-sm header_button" data-bs-toggle="modal" data-bs-target="#audiocallmodal">
                ...
                <div class="chat-body">
                    <div class="missed-call-widget mt-0">
                                ...
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h6 class="text-muted mb-0">
                                            <i class="far fa-clock me-2"></i>Today, 11:43 PM
                                        </h6>
                                    </div>
                        ...
                        <div class="call-view-more">
                            <a href="#"><i class="fas fa-chevron-down me-1"></i> <span>39 More</span></a>
                        </div>
                    </div>
                    ...
                    <div class="other-call-widget mt-0">
                        ...
                        <div class="call-view-more">
                            <a href="#"><i class="fas fa-chevron-down me-1"></i> <span>7 More</span></a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <ul class="nav nav-tabs nav-justified newgroup_ul mt-0" role="tablist">
                                <li class="nav-item">
                                    <a href="#create-group-details" class="nav-link active"
                                        data-bs-toggle="tab" role="tab" aria-selected="true">Members</a>
                                </li>
                            </ul>
                            <!-- Tabs -->
                            <!-- Create chat -->
                                        ...
                                        <div class="card mb-6 group_card_mb">
                                            <div class="card-body">
                                                <div class="media">
                                                    ...
                                                    <div class="align-self-center ms-auto members-call">
                                                        <ul class="list-inline">
                                                            <li class="list-inline-item" data-bs-toggle="tooltip" title=""
                                                                data-original-title="Voice call">
                                                                <a href="javascript:void(0)" class="btn btn-outline-light" data-bs-toggle="modal"
                                                                    data-bs-target="#voice_call" data-bs-dismiss="modal">
