            ...
            <div class="sidebar-menu">
                ...
                <div class="menus-col">
                    <div class="chat-menus">
                        <ul>
                            <li>
                                <a href="index" class="chat-unread blue">
                                    <span class="material-icons">message</span>
                                    <span>Chats</span>
                                </a>
                            </li>
                            <li>
                                <a href="group" class="chat-unread pink">
                                    <span class="material-icons">group</span>
                                    <span>Groups</span>
                                </a>
                            </li>
                            <li>
                                <a href="status" class="chat-unread">
                                    <span class="material-icons">library_books</span>
                                    <span>Status</span>
                                </a>
                            </li>
                            <li>
                                <a href="audio-call" class="chat-unread">
                                    <span class="material-icons">call</span>
                                    <span>Calls</span>
                                </a>
                            </li>
                            <li>
                                <a href="settings" class="chat-unread">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="settings" class="dropdown-item">Settings <span class="material-icons">settings</span></a>
                                    <a href="archived" class="dropdown-item">Archived <span class="material-icons">flag</span></a>
                                    <a href="login-email" class="dropdown-item">Logout <span class="material-icons">power_settings_new</span></a>
                                </div>
                            </li>
                        </ul>
                    </div>
