                    ...
                    <div class="slimscroll">
                       ...
                       <div class="left-chat-title d-flex justify-content-between align-items-center">
                            ...
                            <div class="add-section">
                                <ul>
                                    <li><a href="#" data-bs-toggle="modal" data-bs-target="#add-contact"><span class="material-icons">person_add</span></a></li>
                                </ul>
                            </div>
                       </div>
                       <!-- /Left Chat Title -->
                                ...
                                <li class="user-list-item">
                                    ...
                                    <div class="users-list-body align-items-center">
                                        ...
                                        <div class="last-chat-time">
                                            <a href="#" data-bs-toggle="dropdown" class="contact-toggle">
                                                <i class="fas fa-ellipsis-h"></i>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="#" class="dropdown-item">Share <span class="material-icons">share</span></a>
                                                <a href="#" class="dropdown-item">Block <span class="material-icons">block</span></a>
                                                <a href="#" class="dropdown-item">Remove <span><i class="far fa-trash-alt"></i></span></a>
                                            </div>
                                        </div>    
                                    </div>
                                </li>
                            ...
                            <ul class="user-list mt-2">
                                ...
                                <li class="user-list-item">
                                    ...
                                    <div class="users-list-body align-items-center">
                                        ...
                                        <div class="last-chat-time">
                                            <a href="#" data-bs-toggle="dropdow" class="contact-toggle">
                                                <i class="fas fa-ellipsis-h"></i>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="#" class="dropdown-item">Share <span class="material-icons">share</span></a>
