                    ...
                    <div class="login-left">
                        ...
                        <div class="account-content">
                            ...
                            <div class="form-col">
                                ...
                                <div class="text-center dont-have">Already have an Account?  <a href="login-email">Login</a></div>
                                </form>
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="text-end mt-3 align-items-center">
                                    <button type="button" class="btn btn-block newgroup_create mb-0 close-btn" data-bs-dismiss="modal" aria-label="Close">
                                        Close
                                    </button>
                            </div>
                        </div>       
