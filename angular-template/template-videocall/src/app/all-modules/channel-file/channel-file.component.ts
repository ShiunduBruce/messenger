...
@Component({
  selector: 'app-channel-file',
  templateUrl: './channel-file.component.html',
  styleUrls: ['./channel-file.component.css']
})
export class ChannelFileComponent implements OnInit {
