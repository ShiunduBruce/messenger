...
@Component({
  selector: 'app-blank-channels',
  templateUrl: './blank-channels.component.html',
  styleUrls: ['./blank-channels.component.css']
})
export class BlankChannelsComponent implements OnInit {
