      ...
      <div>
        <div className="header">
          <div className="header-left">
            <a href="/template2/admin" className="logo">
              <img src={logo} alt="Logo" />
            </a>
            <a href="/template2/admin" className="logo logo-small">
                        ...
                        <Dropdown.Item as="button" className="no-padding flex-wrap no-hover">
                            <div className="notifications">
                                ...
                                <div className="topnav-dropdown-footer">
                                    <a href="/template2/admin">View all Notifications</a>
                                </div>
                            </div>
                        </Dropdown.Item>
                    </Dropdown.Menu>
            ...
            <li className="nav-item dropdown has-arrow">
              <Dropdown className="user-dropdown">
                ...
                <Dropdown.Menu>
                  ...
                  <Dropdown.Item href="/template2/admin/settings">
                    {" "}
                    My Profile
                  </Dropdown.Item>
                  <Dropdown.Item href="/template2/admin/settings">Settings</Dropdown.Item>
                  <Dropdown.Item href="/template2/admin/login">Logout</Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
            </li>
          </ul>
