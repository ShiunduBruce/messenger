                                    ...
                                    <table className="table table-hover table-center mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <img className="avatar-img rounded-circle" src={IMG03} alt="User Image" /></a>
                                                        <a href="/template2/admin/settings">Lee <span>#0010</span></a>
                                                    </h2>
                                                </td>
                                                <td>10.00 AM</td>
                                                <td>07 Jun 2019</td>
                                            ...
                                            <img className="avatar-img rounded-circle" src={IMG04} alt="User Image" /></a>
                                                        <a href="/template2/admin/settings">Joe <span>#0010</span></a>
                                                    </h2>
                                                </td>
                                                <td>09.15 AM</td>
                                                <td>28 Sep 2019</td>
                                            ...
                                            <tr>
                                                ...
                                                <img className="avatar-img rounded-circle" src={IMG05} alt="User Image" /></a>
                                                        <a href="/template2/admin/settings">Mary Wiley <span>#0011</span></a>
                                                    </h2>
                                                </td>
                                                <td>04:45 PM</td>
                                                <td>17 Nov 2019</td>
                                            ...
                                            <tr>
                                                ...
                                                <img className="avatar-img rounded-circle" src={IMG06} alt="User Image" /></a>
                                                        <a href="/template2/admin/settings">Eric Knight <span>#0013</span></a>
                                                    </h2>
                                                </td>
                                                <td>02:05 PM</td>
                                                <td>11 Jan 2020</td>
