						...
						<div className="login-left">
							...
							<div className="account-content">
								...
								<div className="form-col">
									...
									<div className="text-center dont-have">Don’t have an account? <a href="/signup-mobile">Signup</a></div>
									<div className="text-center mt-3">
										<span className="forgot-link">
											<a href="/template2/forgotpassword-mobile" className="text-right">Forgot Password ?</a>
										</span>
									</div>
									</form>
								</div>
