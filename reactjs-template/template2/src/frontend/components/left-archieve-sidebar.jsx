...
class Leftarchieveidebar extends Component {
	constructor(props) {
    	super(props);
		this.state = {
		    show: false,
                        ...
                        <div className="sidebar-body" id="chatsidebar">
                            ...
                            <div className="left-chat-title d-flex justify-content-between align-items-center pl-0 pr-0">
                                <div className="chat-title">
                                    <h4><a href="/template2/"><i className="fas fa-arrow-left mr-1"></i> Archived</a></h4>
                                </div>
                            </div>
                                ...
                                <li className="user-list-item">
                                    ...
                                    <div className="users-list-body">
                                        ...
                                        <div className="last-chat-time">
                                            ...
                                            <div className="archive-btn-grey">Archived</div>
                                        </div>    
                                    </div>
                                </li>
                                <li className="user-list-item">
...
export default Leftarchieveidebar;