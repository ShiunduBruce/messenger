...
class Middlechatbody extends Component {
                    ...
                    <div className="chat-header">
                        ...
                        <div className="chat-options">
                            <ul className="list-inline">
                                <li className="list-inline-item">
                                    <span className="archive-btn">Archived</span>
                                </li>
                                ...
                                <div className="chat-content">
                                    <div className="message-content">
                                        <div className="file-download d-flex align-items-center">
                                            <div className="file-type d-flex align-items-center justify-content-center mr-2">
