    		...
    		<div>
	     	 	<div className="sidebar-menu">
	                <div className="logo-col">
	                    <a href="/template2/"><img src={Logo} alt="" /></a>
	                </div>
	                <div className="menus-col">
	                    <div className="chat-menus">
	                        <ul>
	                            <li>
	                                <a href="/template2/" className="chat-unread blue">
	                                    <span className="material-icons">message</span>
	                                    <span>Chats</span>
	                                </a>
	                            </li>
	                            <li>
	                                <a href="/template2/group" className="chat-unread pink">
	                                    <span className="material-icons">group</span>
	                                    <span>Groups</span>
	                                </a>
	                            </li>
	                            <li>
	                                <a href="/template2/status" className="chat-unread">
	                                    <span className="material-icons">library_books</span>
	                                    <span>Status</span>
	                                </a>
	                            </li>
	                            <li>
	                                <a href="/template2/audio-call" className="chat-unread">
	                                    <span className="material-icons">call</span>
	                                    <span>Calls</span>
	                                </a>
	                            </li>
	                            <li>
	                                <a href="/template2/settings" className="chat-unread">
	        	...
	        	<Modal show={this.state.show == 'AddGroupMembers'} onHide={this.handleClose} animation={true} size="md" centered className="shadow-lg">
                    ...
                    <Modal.Body>
                        ...
                        <div className="form-row profile_form text-right float-right m-0 mt-3 align-items-center">
                            <div className="cancel-btn mr-3">
                                <a href="#" onClick={() => this.setState({ show: false })}>Cancel</a>
                            </div>
                            <div className="">
                                <button type="button" className="btn btn-block newgroup_create previous mb-0 mr-3" onClick={() => this.handleShow('AddNewGroup')}>
                                    Previous
                                </button>
                            </div>
                            <div className="">
