...
// Import Images
import { user01, user02, Videocall } from "../imagepath";

    const MeetingcallVertical = () => {
              ...
              <div className="meeting">
                <div className="meeting-wrapper">
                  <div className="meeting-list">
                    {/* Vertical View */}
                    <div className="join-contents vertical-view fade-whiteboard">
                      <div className="join-video user-active">
                        <div className="text-avatar ripple">
                      ...
                      <li className="add-listitem user-active">
                        ...
                        <div className="list-body">
                          <ul className="action-info">
                            ...
                            <li>
                              <a href="#" className="mute-mic voice-act">
...
export default MeetingcallVertical;