                                    ...
                                    <table className="table table-hover table-center mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <img className="avatar-img rounded-circle" src={IMG03} alt="User Image" /></a>
                                                        <a href="/template2-rtl/admin/settings">John Williams <span>#0013</span></a>
                                                    </h2>
                                                </td>
                                                <td>14 Feb 2020</td>
                                                <td>12.03 PM</td>
                                            ...
                                            <img className="avatar-img rounded-circle" src={IMG04} alt="User Image" /></a>
                                                        <a href="/template2-rtl/admin/settings">Amy Bond <span>#0017</span></a>
                                                    </h2>
                                                </td>
                                                <td>18 Apr 2020</td>
                                                <td>09.10 AM</td>
                                            ...
                                            <img className="avatar-img rounded-circle" src={IMG05} alt="User Image" /></a>
                                                        <a href="/template2-rtl/admin/settings">Clara Brady <span>#0019</span></a>
                                                    </h2>
                                                </td>
                                                <td>20 Apr 2020</td>
                                                <td>01.00 PM</td>
                                            ...
                                            <img className="avatar-img rounded-circle" src={IMG06} alt="User Image" /></a>
                                                        <a href="/template2-rtl/admin/settings">Robert Martin <span>#0020</span></a>
                                                    </h2>
                                                </td>
                                                <td>08 Jun 2020</td>
                                                <td>10.00 AM</td>
