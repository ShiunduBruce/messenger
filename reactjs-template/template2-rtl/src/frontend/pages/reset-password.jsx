						...
						<div className="login-left">
							...
							<div className="account-content">
								...
								<div className="form-col">
									...
									<div className="text-center dont-have">Do you have an Account? <a href="/template2-rtl/login-email">Login</a></div>
									</form>
								</div>
								<div className="back-btn-col text-center">
									<a href="/template2-rtl/otp-email"><span><i className="fas fa-caret-left"></i></span> Back</a>
								</div>
							</div>
						</div>
