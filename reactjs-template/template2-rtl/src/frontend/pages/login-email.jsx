						...
						<div className="login-left">
							...
							<div className="account-content">
								...
								<div className="form-col">
									...
									<div className="text-center dont-have">Don’t have an account? <a href="/template2-rtl/signup-email">Signup</a></div>
									<div className="text-center mt-3">
										<span className="forgot-link">
											<a href="/template2-rtl/forgotpassword-email" className="text-right">Forgot Password ?</a>
										</span>
									</div>
									</form>
								</div>
