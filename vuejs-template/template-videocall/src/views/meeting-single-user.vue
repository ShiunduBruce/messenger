		...
		<div class="main-wrapper">
					...
					<div class="meeting-wrapper">
						<div class="join-contents single-view fade-whiteboard">						
							<div class="join-video user-active">
								...
								<div class="more-icon">	
									<a href="javascript:;" class="handraise-on">
										<i class="fas fa-hand-paper"></i>
									</a>
									<a href="javascript:;" class="mic-on">
							...
							<div class="meet-icons">	
										...
										<li class="meet-item  dropdown dropdown-action">
											<a href="javascript:;" class="nav-link dropdown-toggle"  data-bs-toggle="dropdown" aria-expanded="false">
											 ...
											 <ul class="dropdown-menu settings-menu">
												<li><a class="dropdown-item showInviteList" href="javascript:;"><i class="feather-user-plus"></i> Invite People</a></li>
												<li><a class="dropdown-item showChatList" href="javascript:;"><i class="feather-message-circle"></i> Chat</a></li>
												<li><a class="dropdown-item whiteboard" href="javascript:;"><i class="feather-edit-3"></i> Whiteboard</a></li>
												<li><a class="dropdown-item record-icon" href="javascript:;"><i class="far fa-dot-circle"></i> Start Recording</a></li>
												<li><a class="dropdown-item" href="javascript:;"><i class="feather-mic-off"></i> Mute Everyone</a></li>
												<li><a class="dropdown-item" href="javascript:;"><i class="feather-camera-off"></i> Disable Everyone’s Camera</a></li>
												<li><a class="dropdown-item" href="javascript:;"><i class="feather-youtube"></i> Share a Video</a></li>
												<li><a class="dropdown-item" href="javascript:;"><i class="feather-settings"></i> Settings</a></li>
											 </ul>
										</li>
									</ul>
								</div>
									...
									<ul class="meet-items">
										<li class="meet-item  dropdown dropdown-action">
											<a href="javascript:;" class="nav-link dropdown-toggle"  data-bs-toggle="dropdown" aria-expanded="false">
											 ...
											 <ul class="dropdown-menu settings-menu">
												<li><a class="dropdown-item" href="javascript:;"><span class="user-img"><img src="../assets/img/user.jpg" alt="user"> Carl Kelly</span></a></li>
												<li><a class="dropdown-item showInviteList" href="javascript:;"><i class="feather-user-plus"></i> Invite People</a></li>
												<li><a class="dropdown-item" href="javascript:;"><i class="feather-maximize"></i> View Full Screen</a></li>
												<li><a class="dropdown-item record-icon" href="javascript:;"><i class="far fa-dot-circle"></i> Start Recording</a></li>
												<li><a class="dropdown-item" href="javascript:;"><i class="feather-mic-off"></i> Mute Everyone</a></li>
												<li><a class="dropdown-item" href="javascript:;"><i class="feather-camera-off"></i> Disable Everyone’s Camera</a></li>
												<li><a class="dropdown-item" href="javascript:;"><i class="feather-youtube"></i> Share a Video</a></li>
												<li><a class="dropdown-item" href="javascript:;"><i class="feather-settings"></i> Settings</a></li>
												<li><a class="dropdown-item" href="javascript:;"><i class="feather-code"></i> Embed meeting</a></li>
											 </ul>
										</li>
										<li class="meet-item">
								...
								<div class="end-call">
									<ul class="meet-items">
										...
										<li class="meet-item">
											<a href="javascript:;" class="whiteboard">
												<i class="feather-edit-3"></i>
											</a>
										</li>
										<li class="meet-item">
											<a href="javascript:;" class="showChatList">
			...
			<div class="chat-cont-right user-sidebar-right">
				<div class="chat-header">
					<a href="javascript:;" class="close-btn" id="chatClose">
						<i class="feather-x"></i>
					</a>
				</div>
			...
			<div class="chat-cont-right invite-sidebar-right">
				<div class="chat-header">
					...
					<a href="javascript:;" class="close-btn" id="InviteClose">
						<i class="feather-x"></i>
					</a>
				</div>
				<div class="message-body">
							...
							<ul class="add-list">
								<li class="add-listitem user-active">
									...
									<div class="list-body">														
										<ul class="action-info">
											<li>
												<a href="javascript:;" class="mute-vid">
													<i class="feather-video"></i>
												</a>
											</li>
											<li>
												<a href="javascript:;" class="mute-mic">
													<i class="feather-mic"></i>
												</a>
											</li>
										</ul>
								...
								<li class="add-listitem">
									...
									<div class="list-body">														
										<ul class="action-info">
											<li>
												<a href="javascript:;" class="mute-vid text-primary">
