<template>
	<div class="voice-call-page">
        ...
        <!-- sidebar group -->
                    ...
                    <perfect-scrollbar class="scroll-area"  :settings="settings" @ps-scroll-y="scrollHanle">
                       ...
                       <div class="left-chat-title d-flex justify-content-between align-items-center">
                            ...
                            <div class="add-section">
                                <ul>
                                    <li><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add-contact"><span class="material-icons">person_add</span></a></li>
                                </ul>
                            </div>
                       </div>
                       <!-- /Left Chat Title -->
                        ...
                        <div class="search_chat has-search">
                            ...
                            <input class="form-control chat_input" id="search-contact" type="text" placeholder="Search Contacts">
                        </div>
                        ...
                        <div class="sidebar-body" id="chatsidebar">
                                ...
                                <li class="user-list-item">
                                    ...
                                    <div class="users-list-body align-items-center">
                                        ...
                                        <div class="last-chat-time">
                                            <a href="javascript:void(0);" data-bs-toggle="dropdown" class="contact-toggle">
                                                <i class="fas fa-ellipsis-h"></i>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a href="javascript:void(0);" class="dropdown-item">Share <span class="material-icons">share</span></a>
                                                <a href="javascript:void(0);" class="dropdown-item">Block <span class="material-icons">block</span></a>
                                                <a href="javascript:void(0);" class="dropdown-item">Remove <span><i class="far fa-trash-alt"></i></span></a>
                                            </div>
                                        </div>    
                                    </div>
                                </li>
                            ...
                            <span class="contact-name-letter mt-3">J</span>
                            <ul class="user-list mt-2">
                                <li class="user-list-item">
                                    <div class="avatar avatar-online">
                                ...
                                <li class="user-list-item">
                                    ...
                                    <div class="users-list-body align-items-center">
                                        ...
                                        <div class="last-chat-time">
                                            <a href="javascript:void(0);" data-bs-toggle="dropdow" class="contact-toggle">
                                                <i class="fas fa-ellipsis-h"></i>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a href="javascript:void(0);" class="dropdown-item">Share <span class="material-icons">share</span></a>
                            ...
                            <span class="contact-name-letter mt-3">M</span>
                            <ul class="user-list mt-2">
                                <li class="user-list-item">
                                    <div class="avatar avatar-online">
            ...
            <!-- Chat -->
            <div class="chat contactsmiddle" id="middle">
                <div>
                <perfect-scrollbar class="scroll-area"  :settings="settings" @ps-scroll-y="scrollHanle">
                        ...
                        <div class="chat-options">
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a href="javascript:void(0);" class="dropdown-item dream_profile_menu">Archive <span><i class="fas fa-archive"></i></span></a>
                ...
                <div class="right-sidebar-wrap active">
                    ...
                    <perfect-scrollbar class="scroll-area"  :settings="settings" @ps-scroll-y="scrollHanle">
                                                ...
                                                <div class="file-download-col">
                                                    <ul>
                                                        ...
                                                        <li class="full-width text-center">
                                                            <a href="javascript:void(0);" class="load-more-btn">More 154 Files <i class="fas fa-sort-down"></i></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                        ...
                        <div class="report-col">
                            <ul>
                                <li><a href="javascript:void(0);"><span class="material-icons">report_problem</span> Report Chat</a></li>
                                <li><a href="javascript:void(0);"><span><i class="far fa-trash-alt"></i></span> Delete Chat</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row profile_form text-end float-end m-0 align-items-center">
                            ...
                            <div class="cancel-btn me-4">
                                <a href="javascript:void(0);" data-bs-dismiss="modal" aria-label="Close">Cancel</a>
                            </div>
                            <div class="">
                            ...
                            <div class="call-wrapper">
                                <div class="call-inner">
                                    ...
                                    <div class="call-items">
                                        ...
                                        <a href="javascript:void(0);" class="btn call-item call-start" data-bs-dismiss="modal">
                                            <i class="fas fa-video"></i>
                                        </a>
                                    </div>
                                </div>
