        ...
        <!-- sidebar group -->
                    ...
                    <perfect-scrollbar class="scroll-area"  :settings="settings" @ps-scroll-y="scrollHanle">
                       ...
                       <div class="left-chat-title d-flex justify-content-between align-items-center">
                            ...
                            <div class="add-section">
                                <ul>
                                    <li><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add-status"><span class="material-icons">library_add</span></a></li>
                                </ul>
                            </div>
                       </div>
                       <!-- /Left Chat Title -->
                        ...
                        <div class="sidebar-body" id="chatsidebar">
                            ...
                            <ul class="user-list mt-2">
                                <li class="user-list-item">
                                    <a href="javascript:void(0);" class="d-flex" data-bs-toggle="modal" data-bs-target="#status-modal">
                                ...
                                <li class="user-list-item">
                                    <a href="javascript:void(0);" class="d-flex w-100" data-bs-toggle="modal" data-bs-target="#status-modal">
                                        <div>
            ...
            <div class="chat status-middle-bar d-flex align-items-center justify-content-center">
                <div class="status-right">
                    <div><img src="../assets/img/status-icon.png" alt=""></div>
                    <div>
                    ...
                    <div id="carouselIndicators" class="carousel slide slider" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner status_slider" role="listbox">
                            <div class="carousel-item active">
                                <img src="../assets/img/status1.jpg" alt="">
