                ...
                <div id="chats" class="left-sidebar-wrap sidebar active">
                    ...
                    <perfect-scrollbar class="scroll-area"  :settings="settings" @ps-scroll-y="scrollHanle">
                        ...
                        <div class="settings-option">
                            <a href="javascript:void(0);" class="user-list-item">Edit Settings</a>
                        </div>
                        <!-- Settings Option For Mobile -->
                        ...
                        <div class="profile-card">
                            <div class="profile-cover text-center mb-3">
                                ...
                                <p class="profile-email mb-1">michelle.green@gmail.com</p>
                            ...
                            <div class="profile-info">
                                ...
                                <div class="text-center mb-4">
                                    ...
                                    <span class="info-text">alberywo@gmail.com</span>
                                </div>
                        ...
                        <div class="settings-card">
                            ...
                            <div class="settings-footer">
                                <ul class="p-0 mb-0">
                                    <li>
                                        <a href="javascript:void(0);"><i class="fas fa-chevron-right"></i>  Need Help? Let's chat</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"><i class="fas fa-chevron-right"></i>  English (united States)</a>
                                    </li>
                                </ul>
                                ...
                                <div class="security-settings">
                                    ...
                                    <div class="authentication">
                                        ...
                                        <div class="align-items-center">
                                            <label class="custom-radio me-2">Password <br> <span><a href="javascript:void(0);"  data-bs-toggle="modal" data-bs-target="#password-authentication">edit</a></span>
                                            <input type="radio" name="radio">
                                            <span class="checkmark"></span>
                                            </label>
                                            <label class="custom-radio me-2">Sequrity Question <br> <span><a href="javascript:void(0);"  data-bs-toggle="modal" data-bs-target="#question-authentication">edit</a></span>
                                            <input type="radio" name="radio">
                                            <span class="checkmark"></span>
                                            </label>
                                        </div>
                    ...
                    <div class="modal-body">
                        <div class="success-icon delete-tab text-center">
                            ...
                            <div class="text-center">
                                <a href="javascript:void(0);"><i class="fas fa-check me-2"></i></a>
                                <a href="javascript:void(0);"><i class="fas fa-times close-icon"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
