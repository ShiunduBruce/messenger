<template>
	<div>
        ...
        <!-- sidebar group -->
                    ...
                    <perfect-scrollbar class="scroll-area"  :settings="settings" @ps-scroll-y="scrollHanle">
                       ...
                       <div class="left-chat-title d-flex justify-content-between align-items-center">
                            ...
                            <div class="add-section">
                                <ul>
                                    <li><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add-new-group"><span class="material-icons group-add-btn">group_add</span></a></li>
                                </ul>
                            </div>
                       </div>
                       <!-- /Left Chat Title -->
            ...
            <!-- Chat -->
            <div class="chat groupmiddle" id="middle">
                <div>
                <perfect-scrollbar class="scroll-area"  :settings="settings" @ps-scroll-y="scrollHanle">
                ...
                <div class="right-sidebar-wrap active">
                    ...
                    <perfect-scrollbar class="scroll-area"  :settings="settings" @ps-scroll-y="scrollHanle">
                            ...
                            <div class="mt-0 right_sidebar_logo">
                                <div class="text-center mb-2 right-sidebar-profile">
                                    ...
                                    <div class="edit-group">
                                        <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit-new-group"><span><i class="fas fa-edit"></i></span> Edit Group</a>
                                    </div>
                                </div>
                                <div>
                                            ...
                                            <div class="tab-pane fade" id="Participants">
                                               <div class="participants-list">
                                                            ...
                                                            <div class="users-list-body d-flex justify-content-between">
                                                                ...
                                                                <div class="grp-delete"> 
                                                                    <div class="chat-action-col">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <a href="javascript:void(0);" class="dropdown-item">Delete <span><i class="far fa-trash-alt"></i></span></a>
                                                                            <a href="javascript:void(0);" class="dropdown-item">Mute <span class="material-icons">volume_off</span></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="text-center">
                                                        <a href="javascript:void(0);" class="load-more-btn">More 54 <i class="fas fa-sort-down"></i></a>
                                                    </div>
                                               </div>
                                            </div>
                        ...
                        <div class="report-col">
                            <ul>
                                <li><a href="javascript:void(0);"><span><i class="fas fa-sign-out-alt"></i></span> Exit Group</a></li>
